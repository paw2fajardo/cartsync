    ...
    <>
      <div className="flex items-center gap-2 w-full">
        ...
        <button
          ...
          className="flex items-center gap-1.5 px-3 py-2 rounded-2xl text-xs font-bold bg-emerald-50 hover:bg-emerald-100 dark:bg-emerald-950/50 dark:hover:bg-emerald-900/60 text-emerald-700 dark:text-emerald-300 border border-emerald-200 dark:border-emerald-800/80 whitespace-nowrap active:scale-95 transition-all shrink-0 cursor-pointer shadow-2xs"
        ...
        {canDeleteActive && activeList && (
          <button
            ...
            className="p-2 rounded-2xl text-zinc-400 hover:text-rose-600 dark:hover:text-rose-400 hover:bg-rose-50 dark:hover:bg-rose-950/40 border border-transparent hover:border-rose-200 dark:hover:border-rose-900/60 active:scale-95 transition-all shrink-0 cursor-pointer"
