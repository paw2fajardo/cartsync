      ...
      <div className="fixed inset-0 z-40 flex">
        ...
        <div className="relative w-80 max-w-[85vw] bg-white dark:bg-zinc-900 h-full shadow-2xl flex flex-col z-50 animate-in slide-in-from-left duration-200">
          ...
          <div className="flex-1 overflow-y-auto p-4 space-y-2">
            <div className="text-[11px] font-bold uppercase tracking-wider text-zinc-500 dark:text-zinc-400 px-2">
                  ...
                  >
                    ...
                    {lists.length > 1 && (
                      <button
                        ...
                        className="absolute right-2.5 top-2.5 p-2 rounded-xl text-zinc-400 hover:text-rose-600 dark:hover:text-rose-400 hover:bg-rose-50 dark:hover:bg-rose-950/40 active:scale-95 transition-all cursor-pointer"
